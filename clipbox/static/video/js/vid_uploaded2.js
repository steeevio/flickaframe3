...
function create_post() {
	...
	$.ajax({
		...
		success : function(json){
			...
			var str_slide = json.slide_image;
			if(str_slide != null){
				var n_slide = str_slide.lastIndexOf('\\');
				var slide_image_result = str_slide.substring(n_slide + 1);
			}
			...
			$('#tags_on_load').prepend(
				"<div id=\"tag_" + json.tagpk + "\">" +
					...
					"<img class= 'image_comments' src='/static/video/uploaded_slide_images/" + slide_image_result + "'> </br>" + 

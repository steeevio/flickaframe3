...
function create_post() {
	...
	$.ajax({
		...
		success : function(json){
			...
			$('#tags_on_load').prepend("<div id=\"tag_" + json.tagpk + "\"  ><strong>" + json.tag_title + "</strong> - <em> " + json.tag_description + "</br>  <img class=\"image_comments\" src=\" " + json.tag_image + " \"> </br>" + json.tag_start_string + " </br> <a id='delete_tag-" + json.tagpk + "'> delete me</a></li>" +    " <button onclick = \"javascript:delete_tag( " + json.tagpk + "); \">Delete Tag</button>" +"</div>")
...
function seekTimeUpdate(){
	...
	curtimetext.innerHTML = curmins + ":" + cursecs + video_percent;
	durtimetext.innerHTML = durmins + ":" + dursecs;

	return curmins + ":" + cursecs;
	console.log(video_percent)
	if(Number(video_percent) > 5){
		vid.pause();
		}
	}

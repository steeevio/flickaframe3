...
function create_post() {
	...
	$.ajax({
		...
		success : function(json){
			...
			$('#videos_tags').prepend("<div><strong>" +json.tag_title+ "</strong> - <em> " + json.tag_description + "</br>  " + json.tag_image + " </br>" + json.tag_start_string + "</div>")
		},
...
function createTab(){
	...
	var dataURLcomments = "<img class=\"image_comments\" src=\"  " + dataURL + " \">";
